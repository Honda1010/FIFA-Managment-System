 ...
 * @author MOHAMED
 */
public class match_entity_league_prev {
    ...
    public match_entity_league_prev(String league_name, int league_week, String match_date, String match_result, String Home, String Away) {
